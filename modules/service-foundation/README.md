...
migrations and, for JSON Keys, rotation. It declares specifications only; job-writer and execution
authority remain separate foundation work, not implicit grants to the API rollout workers.
