...
func TestFoundationInputs(t *testing.T) {
	...
	for _, testCase := range []struct {
		...
		{name: "DuplicateProject", variable: "FOUNDATION_CONFIG", value: `{"management_project_id":"agora-management-test","region":"europe-west1","service_projects":{"json-keys":"agora-json-keys-test","authentication":"agora-json-keys-test"}}`},
