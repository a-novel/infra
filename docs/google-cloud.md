...
Authentication initialization. Each production API keeps one service-level warm instance and scales
up to three. Jobs run only when invoked; disposable recovery services retain minimum zero. All
