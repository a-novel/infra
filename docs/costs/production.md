...
| Cloud Scheduler                       | USD 0.10/job/month, with three jobs free per billing account                                                            | Five recovery schedules add about USD 0.20/month when the billing account's free allowance is otherwise unused.                                                            |
