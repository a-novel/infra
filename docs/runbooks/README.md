...
| [Deploy and roll back production](./deploy-production.md)                          | Protected release inputs, image verification, fixed deployment order, manual initialization, immutable receipts, and whole-app compensation or rollback.             | Foundation changes, data restoration, automatic deployment on manifest merge, or direct `gcloud` release changes.   |
